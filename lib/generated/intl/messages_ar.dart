...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    "Received": MessageLookupByLibrary.simpleMessage("أستلم"),
    "accountAndPreferences": MessageLookupByLibrary.simpleMessage(
      "الحساب والتفضيلات",
    ),
    "amount": MessageLookupByLibrary.simpleMessage("المبلغ"),
    "amountValidation": MessageLookupByLibrary.simpleMessage("المبلغ غير صالح"),
    ...
    "enterOtp": MessageLookupByLibrary.simpleMessage(
      "أدخل الرمز المكون من 6 أرقام المرسل عبر الرسائل القصيرة",
    ),
    ...
    "featureForward": MessageLookupByLibrary.simpleMessage(
      "أرسل واستقبل وأدر أموالك — كل ذلك في مكان واحد.",
    ),
    ...
    "setDisplayName": MessageLookupByLibrary.simpleMessage(
      "قم بتعيين اسم العرض الخاص بك",
    ),
